const styles: Record<string, string> = {
  ...
  buzo: "bg-slate-500/15 text-slate-400 ring-slate-500/30",
  pendiente: "bg-red-500/15 text-red-400 ring-red-500/30",
  validada: "bg-emerald-500/15 text-emerald-400 ring-emerald-500/30",
};
